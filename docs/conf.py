...
html_theme_options = {
    ...
    'header_links' : [
        ('Install', 'install/install-more', True, 'fas fa-download'),
        ('API', 'api/index', True, 'fas fa-book'),
        ('Community', 'website/index', True, 'fab fa-discourse'),
        ('Contribute', 'website/contribute', True, 'fas fa-laptop-code'),
