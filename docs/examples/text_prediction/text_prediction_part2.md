...
```sh
!nlp_data prepare_glue --benchmark glue -t sst -d /gluonnlp/tmp1
!nlp_data prepare_glue --benchmark glue -t sts -d /gluonnlp/tmp2
```
...
```{.python .input}
sst_train_df = pd.read_parquet('/gluonnlp/tmp1/glue/sst/train.parquet')
...
sst_dev_df = pd.read_parquet('/gluonnlp/tmp1/glue/sst/dev.parquet')
```
...
```{.python .input}
# Load STS
sts_train_df = pd.read_parquet('/gluonnlp/tmp2/glue/sts/train.parquet')[['sentence1', 'sentence2', 'score']]
sts_dev_df = pd.read_parquet('/gluonnlp/tmp2/glue/sts/dev.parquet')[['sentence1', 'sentence2', 'score']]
```
